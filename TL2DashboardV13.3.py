        ...
        <style>
            ...
            * { box-sizing: border-box; margin: 0; padding: 0; }
            ...
            @keyframes card-blink {
                ...
                50%      { box-shadow: 0 0 18px 4px #ffd23f; opacity: 0.72; }
            }
    ...
    <body>
        ...
        <div class="section">
            ...
            <div class="list-wrapper">
                <table class="list-table">
                    ...
                    <tbody id="list-body">
                        <tr><td colspan="9" style="text-align:center;color:#484f58;padding:24px;">กำลังโหลด...</td></tr>
                    </tbody>
                </table>
            </div>
        </div>
        ...
        <script>
            ...
            function sortList(col) {
                ...
                ['name','status','part','user','rate','sim','remaining','update'].forEach(function(c) {
            ...
            function renderList() {
                ...
                if (!rows.length) {
                    document.getElementById('list-body').innerHTML='<tr><td colspan="9" style="text-align:center;color:#484f58;padding:24px;">ไม่พบข้อมูล</td></tr>';
                    return;
                }
                var html='';
            ...
            function applyBlinkClass() {
                ...
                cards.forEach(function(card) {
                    ...
                    if (cardDisplayMode==='remain' && remSec!==null && remSec>0 && remSec<threshSec) {
                        ...
                        fetch('/api/pn_config')
                            ...
                            .then(function(cfg2) {
                                ...
                                allM.forEach(function(m) {
                                    ...
                                    mb+='<div class="card '+si.cardClass+'" data-type="'+si.type+'" data-part="'+safePart+'" data-runtime="'+rtSec+'" data-runrate="'+info.run_rate+'" data-remain="'+remAttr+'" style="background:'+pc.bg+';'+gs+'">'+
