            ...
            <div class="list-wrapper">
                <table class="list-table">
                    <thead><tr>
                        ...
                        <th>Spindle</th>
                        <th onclick="sortList('sim_time')" id="th-sim">Sim Time</th>
        ...
        <script>
            ...
            function sortList(col) {
                ...
                ['name','status','part','user','rate','sim','update'].forEach(function(c) {
                    ...
                    if (c===col) th.classList.add(sortAsc?'sort-asc':'sort-desc');
                });
                renderList();
            }
                ...
                rows.forEach(function(d) {
                    ...
                    html+=
                        ...
                        '<td style="color:#ffe082;font-weight:700;text-align:right;">'+
                            (d.sim_time>0?(function(s){var m=Math.floor(s/60),sc=s%60;return String(m).padStart(3,'0')+':'+String(sc).padStart(2,'0');})(d.sim_time):'—')+
                        '</td>'+
                ...
                fetch('/api/machines')
                    ...
                    .then(function(data) {
                        ...
                        allM.forEach(function(m) {
                            ...
                            mb+='<div class="card '+si.cardClass+'" data-type="'+si.type+'" data-part="'+safePart+'" style="background:'+pc.bg+';'+gs+'">'+
                                '<div class="top-row"><h2 class="machine-name">'+m+'</h2><div class="run-rate '+si.textClass+'">'+info.run_rate+'%</div></div>'+
